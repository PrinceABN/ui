...
namespace sdk {
	namespace drawing {
		...
		sdk::c_function rect_thik( int x, int y, int w, int h, color::col_t c, int rounding, int thic );
		c_function image( int x, int y, int w, int h, ImTextureID user_texture_id, color::col_t c = color::col_t( ) );
		...
		sdk::c_function text_fill( float x, float y, float fill_value, int font_index, const char* text, bool dropshadow );
